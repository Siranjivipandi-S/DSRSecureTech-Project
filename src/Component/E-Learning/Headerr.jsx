    ...
    <header className=" text-black">
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex text-lg space-x-10">
          ...
          <HashLink smooth to="/api/elearning/##contacts" className="hover:text-gray-400">
            Contact
          </HashLink>
      ...
      >
        ...
        <HashLink smooth to="/api/elearning/##contacts" className="text-xl font-medium hover:text-gray-400">
            Contact
          </HashLink>
        <a
          href="#"
