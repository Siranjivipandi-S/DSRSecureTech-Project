  ...
  return (
    <header className="text-black">
      <nav className="flex items-center justify-between p-4 md:p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="hidden md:flex text-lg space-x-4 lg:space-x-10">
          <a href="/" className="hover:text-gray-400">
            Home
          </a>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-16 z-10 inset-0 h-[400px]  bg-[#2B59FF] text-black transition-transform transform ${
      ...
      >
        ...
        <HashLink
          smooth
          to="/#features"
          className="text-xl font-medium hover:text-gray-400"
        >
          Features
        </HashLink>
        <HashLink
        ...
        <HashLink smooth to='/#contact' className="text-xl font-medium hover:text-gray-400">
          Contact
        </HashLink>
        <a
          href="#"
